...
# Dataset
dataset = 'tv_poster'
# Path to image text file in dataset
...
for i in range(0, len(imagePaths) - 1):
    ...
    try:
        ...
        if len(src_pts) >= 4 and len(dst_pts) >= 4:               
            ...
            cv2.moveWindow('Combined', 1000, 800)
...
print("homography_list=",all_homographies)
with open('feature_frames/'+dataset+'_image_homographies.txt', 'w') as f:
    f.write('[')
